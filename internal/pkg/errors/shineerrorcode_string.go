...
func _() {
	...
	_ = x[UnitTestError-16]
}

const _ShineErrorCode_name = ""

var _ShineErrorCode_index = [...]uint16{0, 16, 47, 77, 113, 144, 172, 199, 228, 255, 279, 308, 344, 371, 390, 409, 434, 447}
