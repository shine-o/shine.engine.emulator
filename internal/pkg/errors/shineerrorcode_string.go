...
func _() {
	...
	_ = x[UnitTestError-17]
}

const _ShineErrorCode_name = ""

var _ShineErrorCode_index = [...]uint16{0, 16, 47, 77, 113, 144, 172, 199, 228, 255, 279, 308, 344, 371, 401, 420, 439, 464, 477}
